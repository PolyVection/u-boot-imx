...
#define DSP_RST IMX_GPIO_NR(4, 19)
...
void audclk_init(void){
	gpio_direction_output(DSP_RST, 1);
	//gpio_direction_output(AUD_MCLK1_SW, 0);
	//gpio_direction_output(AUD_MCLK2_SW, 0);
...
//	reg = 0x40;
//	pmic_reg_write(pfuze, PFUZE3000_SW1ACONF, reg);
//
...
//	reg = 0xb;
//	pmic_reg_write(pfuze, PFUZE3000_SW1ASTBY, reg);
//	
//	/* OFF-DELAY-ON cycle 33V LDO for resetting AMP + ADC */
//	reg = 0x03;
//	pmic_reg_write(pfuze, PFUZE3000_V33CTL, reg);
//	udelay(60000);
//	reg = 0x13;
//	pmic_reg_write(pfuze, PFUZE3000_V33CTL, reg);
...
/*
 * polydsp1 board default supports sd card. If want to use
